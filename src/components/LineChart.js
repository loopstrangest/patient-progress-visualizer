// Imports: dataviz library, unix time formatting library
...
const LineChartDisplay = (
    ...
    <ResponsiveContainer width="95%" height="90%" margin="auto">
        ...
        */}
        ...
        ticks={unixTimeTicks} type="number"
        ...
        */}
        ...
        <Label value="GAD-7 Score" position="insideLeft"
        offset={15} angle={-90}/>
        </YAxis>
        <YAxis yAxisId="right" orientation="right"
        type="number" ticks={[0, 9, 18, 27]} domain={[0, 27]}>
        <Label value="PHQ-9 Score" position="insideRight"
        offset={15} angle={-90}/>
        </YAxis>
        {/*
